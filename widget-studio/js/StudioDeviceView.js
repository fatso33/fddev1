...
export class StudioDeviceView {
  ...
  render() {
    ...
    const finishDiagnosticTiming = this.state.diagnostics?.begin();
    this.state.diagnostics?.count('studio.preview.rebuilds');
    ...
    finishDiagnosticTiming?.('studio.preview.rebuildDurationMs');
  }
