  ...
  // 1. NAV 1 Radio Decomposed Widget (§5.4)
  {
    ...
    components: [
      ...
      },
      {
        ...
        props: { variant: 'preset', label: 'ILS', sublabel: '110.30', presetSlot: 0 },
        interactions: [
          { trigger: 'tap', action: { type: 'core.applyPresetToField', field: 'stbyFreq', presetSlot: 0 } }
        ]
      },
      {
        id: 'btn_preset2',
        ...
        props: { variant: 'preset', label: 'VOR', sublabel: '113.70', presetSlot: 1 },
        interactions: [
          { trigger: 'tap', action: { type: 'core.applyPresetToField', field: 'stbyFreq', presetSlot: 1 } }
        ]
      },
      {
        id: 'btn_preset3',
        ...
        props: { variant: 'preset', label: 'LOC', sublabel: '109.90', presetSlot: 2 },
        interactions: [
          { trigger: 'tap', action: { type: 'core.applyPresetToField', field: 'stbyFreq', presetSlot: 2 } }
        ]
      },
      {
        id: 'btn_preset4',
        ...
        props: { variant: 'preset', label: 'DME', sublabel: '115.10', presetSlot: 3 },
        interactions: [
          { trigger: 'tap', action: { type: 'core.applyPresetToField', field: 'stbyFreq', presetSlot: 3 } }
        ]
      }
    ],
    capabilities: {
